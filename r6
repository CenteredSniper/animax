...
local Figure = Character["AnimaXReanimate"]
...
Character.Humanoid.Climbing:connect(onClimbing)
Character.Humanoid.GettingUp:connect(onGettingUp)
Character.Humanoid.FreeFalling:connect(onFreeFall)
Character.Humanoid.FallingDown:connect(onFallingDown)
Character.Humanoid.Seated:connect(onSeated)
Character.Humanoid.PlatformStanding:connect(onPlatformStanding)
Character.Humanoid.Swimming:connect(onSwimming)
